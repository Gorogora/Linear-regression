...
def batch_gradient_descent(dataX, dataY, theta, m, num_atrib, alpha):
    # update theta
...
def stochastic_gradient_descent(dataX, dataY, theta, m, num_atrib, alpha):
...
def selected_learning_rate(dataX, dataY, theta, m, num_atrib, alpha, num_iterations):
    ...
    for i in range(len(alpha)):
        ...
        for it in range(num_iterations):
            ...
            theta = batch_gradient_descend(dataX, dataY, theta, m, num_atrib, alpha[i])
...
def part_one(dataX, dataY, theta, m, num_atrib, alpha, num_iterations, mu, sigma):
    for it in range(num_iterations):
        theta = batch_gradient_descend(dataX, dataY, theta, m, num_atrib, alpha)
